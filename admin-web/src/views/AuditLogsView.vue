...
const labels:Record<string,string>={'school.create':'新增学校','school.update':'修改学校','area.create':'新增区域','area.update':'修改区域','user.update':'修改用户','review.hide':'隐藏评论','review.restore':'恢复评论','check_in.hide':'隐藏打卡','check_in.restore':'恢复打卡','admin.create':'新增管理员','admin.update':'修改管理员','message.create':'新建消息','message.update':'修改消息','message.publish':'发布消息','message.revoke':'撤回消息'}
