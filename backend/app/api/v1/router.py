...
from app.api.v1 import admin_auth, admin_management, admin_messages, admin_stores, admin_uploads, auth, checkins, history, messages, reviews, states, stores, users
...
router.include_router(admin_messages.router)
